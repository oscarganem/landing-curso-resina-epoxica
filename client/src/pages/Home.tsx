...
const faqItems = [
  ...
  {
    question: "¿Registrarme a la lista tiene algún costo o me obliga a comprar?",
    answer: <><p>No. <strong>Registrarte es completamente GRATIS y no te compromete a comprar el curso.</strong></p><p>La lista simplemente te permitirá recibir primero la información, acceder a la clase online y conocer las condiciones especiales de preventa.</p></>,
  },
  {
    question: "¿La clase online previa también es gratuita?",
    answer: <><p>Sí. Al registrarte recibirás acceso completamente GRATIS a nuestra clase online previa al curso presencial.</p><p>Durante la clase conocerás al equipo, aprenderás <strong>las 5 capas que conforman un piso epóxico</strong>, verás una <strong>demostración en vivo</strong> y podrás resolver tus dudas sobre el curso presencial.</p><p>Al final de la clase revelaremos el precio especial de preventa disponible exclusivamente para los miembros de la lista prioritaria.</p></>,
  },
  {
    question: "¿Necesito experiencia previa para tomar el curso?",
    answer: <><p>No. El curso está diseñado para que puedas <strong>aprender desde cero</strong>, incluso si nunca antes has trabajado con resina epóxica.</p><p>Durante el presencial aprenderás los fundamentos, preparación de superficies, aplicación y diferentes tipos de acabados.</p></>,
  },
  {
    question: "¿Cuánto cuesta el curso presencial?",
    answer: <><p>El <strong>precio especial de preventa</strong> será revelado durante nuestra clase online gratuita.</p><p>Las personas registradas en la lista tendrán acceso primero a este precio antes de que abramos las inscripciones al público general.</p></>,
  },
  {
    question: "¿Cómo podré reservar mi lugar?",
    answer: <><p>Durante la clase online explicaremos cómo acceder a la preventa y <strong>asegurar tu lugar en el curso presencial</strong>.</p><p>Los miembros de la lista tendrán prioridad antes de abrir los lugares restantes al público.</p></>,
  },
  {
    question: "¿Qué incluye mi inscripción al curso presencial?",
    answer: <><p>Tu inscripción incluye la formación presencial práctica, materiales y herramientas para realizar las prácticas, Manual del Aplicador, calculadora de materiales, certificado de participación y soporte posterior al curso.</p></>,
  },
  {
    question: "¿Tengo que llevar materiales o herramientas?",
    answer: <><p>No. Durante el curso te proporcionaremos <strong>los materiales y herramientas necesarios para realizar las prácticas</strong>.</p><p>Solo tendrás que presentarte con ganas de aprender.</p></>,
  },
  {
  ...
  },
  {
    ...
    answer: <><p>Si ofrecemos una repetición de la clase, recibirás el acceso posteriormente por WhatsApp y correo durante un periodo limitado.</p><p><strong>Te recomendamos asistir en vivo</strong>, ya que podrás hacer preguntas directamente al equipo y conocer de primera mano la oferta especial de preventa.</p></>,
  },
];
    ...
    <main className="landing-shell">
      ...
      <section className="hero" id="inicio" aria-labelledby="course-title">
        <div className="hero-copy">
          ...
          <a className="waitlist-cta" href="#lista-de-espera">Únete GRATIS a la lista de espera <MoveUpRight aria-hidden="true" /></a>
