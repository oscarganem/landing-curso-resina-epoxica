...
describe("landing de Cancún", () => {
  ...
  it("muestra la oferta directa de Cancún y deja la sede pendiente de información confirmada", () => {
    ...
    expect(landingSource).not.toContain("Mérida");
    expect(landingSource).not.toContain("WaitlistModal");
  });
  ...
  it("activa los paquetes con WhatsApp y el mensaje predeterminado correspondiente", () => {
    ...
    expect(landingSource).toContain("Hola, quiero información sobre la preventa de $1,999 para el Curso de Resina Epóxica en Cancún.");
    expect(landingSource).toContain("Hola, quiero registrarme con la opción de pago al llegar de $2,499 para el Curso de Resina Epóxica en Cancún.");
    expect(landingSource).toContain("Hola, quiero información sobre los paquetes para parejas y equipos del Curso de Resina Epóxica en Cancún.");
